...
import { ChevronDown, Plus, FileText, List, BarChart3, Heart, Clock, Command } from 'lucide-react'
...
export function Sidebar() {
  ...
  const [expandedSections, setExpandedSections] = useState<string[]>(['Danh mục', 'Quản lý'])
